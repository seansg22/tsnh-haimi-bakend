...
- Every single bullet across ALL sections below must show progress by comparing week ${age.weeks} to week ${age.weeks - 1}.
- Each bullet should state what changed or what is new/different this week, not what is generally true.
- No bullet should describe something that was already the same last week.
...
- Keep each bullet 2–3 sentences max — fact-based, concrete and actionable, not generic
...
Rules:
- All fields must be present including newThisWeek and motherWellness with nutrition and exercise arrays
